...
void validate_detector_loss(char *datacfg, char *cfgfile, char *weightfile, int dont_show, int ngpus, int clear, int show_imgs, int benchmark_layers)
{
    list *options = read_data_cfg(datacfg);
    char *train_images = option_find_str(options, "train", "data/train.txt");
    char *valid_images = option_find_str(options, "valid", train_images);
...
void run_detector(int argc, char **argv)
{
    ...
    else if (0 == strcmp(argv[2], "loss")) validate_detector_loss(datacfg, cfg, weights, dont_show, ngpus, clear, show_imgs, benchmark_layers);
